...
public class chandelierCrash : MonoBehaviour {
    ...
    public void Break()
    {
        ...
        {
            transform.GetChild(1).GetChild(i).FindChild("BrokenLamp").gameObject.SetActive(true);
            transform.GetChild(1).GetChild(i).FindChild("Lamp").gameObject.SetActive(false);
        }
    }
